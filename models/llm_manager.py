...
class LLMManager:
    ...
    #         if context:
    #             messages.append({"role": "system", "content": f"Here is relevant context from previous customer(not from this customer) conversations:\n{context}"})
    ...
    #     else:  
    #         # local model
    #         # Prompt for instruction-tuned models
    ...
    #         response_text = self.llm.invoke(prompt_template)
